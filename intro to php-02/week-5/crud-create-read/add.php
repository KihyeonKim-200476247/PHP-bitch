...
<html lang="en">
    <head>
        ...
        <meta name="description" content="This page will be used to add a record to our database">
            ...
            <section class="add-form">
                <div class="row">
                    <div class="panel panel-default user-add-edit">
                        <div class="panel-heading"> <a href="index.php" class="glyphicon glyphicon-arrow-left">Add User</a></div>
